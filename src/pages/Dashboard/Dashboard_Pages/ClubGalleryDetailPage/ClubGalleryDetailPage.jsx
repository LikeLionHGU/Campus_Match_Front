...
const ClubGalleryDetailPage = () => {
  ...
  const fetchGallery = useCallback(async (currentFilter) => {
    try {
      ...
      let url = `${import.meta.env.VITE_HOST_URL}/api/gallery/${clubId}`;

      if (currentFilter === "our") {
        url = `${import.meta.env.VITE_HOST_URL}/api/gallery/myClub/${clubId}`;
      } else if (currentFilter === "matchup") {
        url = `${import.meta.env.VITE_HOST_URL}/api/gallery/match/${clubId}`;
      }
  ...
  const handleCardClick = async (item) => {
    try {
      ...
      const response = await fetch(
        `${import.meta.env.VITE_HOST_URL}/api/gallery/detail/${item.galleryId}`,
        {
          method: "GET",
          headers: {
            Authorization: token || "",
