    ...
    return(
        <>
            <div className="matchup-cancel-modal-backdrop" onClick={onClose}>
                <div className="matchup-cancel-modal" onClick={(e) => e.stopPropagation()}>
                    <img
                        src={closeIcon}
                        alt="close"
                    ...
                    <div className="matchup-cancel-modal-main">
                        ...
                        <div className="matchup-cancel-modal-button">
                            <button className="matchup-cancel-left-button" onClick={onClose}>취소</button>
                            <button className="matchup-cancel-right-button" onClick={handleCancelConfirm}>확인</button>
                        </div>
                    </div>
                </div>
