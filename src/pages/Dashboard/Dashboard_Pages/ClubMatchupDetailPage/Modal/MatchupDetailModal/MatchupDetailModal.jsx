  ...
  useEffect(() => {
    const fetchDetail = async () => {
      try {
        ...
        if (type === "receive") {
          url = `${import.meta.env.VITE_HOST_URL}/api/matchRequest/receive/${matchRequestId}`;
        } else if (type === "send") {
          url = `${import.meta.env.VITE_HOST_URL}/api/matchRequest/send/${matchRequestId}`;
        } else if (type === "ongoing") {
          url = `${import.meta.env.VITE_HOST_URL}/api/matchPost/ongoing/${matchPostId}`;
        } else if (type === "upcoming") {
          url = `${import.meta.env.VITE_HOST_URL}/api/matchPost/upcoming/${matchPostId}`;
        }
