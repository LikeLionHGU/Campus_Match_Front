  ...
  const fetchHistory = useCallback(async () => {
    try {
      ...
      const response = await fetch(
        `${import.meta.env.VITE_HOST_URL}/api/matchHistory/${clubId}`,
        {
          method: "POST",
          headers: {
        ...
        <div className="history-list-container">
          ...
          <div className="history-pagination">
            <div className="pagination-move">
              <img
                className="history-pagination-double"
                src={ArrowLeftDouble}
                alt="<<"
                onClick={() => setCurrentPage((prev) => Math.max(1, prev - 10))}
              />
              <img
                className="history-pagination-mono"
                src={ArrowLeft}
                alt="<"
            ...
            <div className="pagination-move">
              ...
              <img
                ...
                alt=">>"
                onClick={() => setCurrentPage((prev) => Math.min(totalPages || 1, prev + 10))}
              />
            </div>
          </div>
        </div>
