...
const ClubIntroModal = ({ clubId, onClose, onUpdate }) => {
  ...
  const fetchDescription = useCallback(async () => {
    try {
      const res = await fetch(
        `${process.env.REACT_APP_HOST_URL}/api/club/description/${clubId}`,
        {
          method: "GET",
  ...
  const handleAddAward = async () => {
    ...
    try {
      const res = await fetch(
        `${process.env.REACT_APP_HOST_URL}/api/club/award`,
        {
          method: "POST",
          headers: {
  ...
  const handleDeleteAward = async (awardId) => {
    try {
      const res = await fetch(
        `${process.env.REACT_APP_HOST_URL}/api/club/award/${awardId}`,
        {
          method: "DELETE",
          headers: { Authorization: token || "" },
        },
  ...
  const handleUpdateDescription = async () => {
    try {
      const res = await fetch(
        `${process.env.REACT_APP_HOST_URL}/api/club/description`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
